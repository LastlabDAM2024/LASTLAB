...
public class MedListAdapter extends RecyclerView.Adapter<MedListAdapter.ListViewHolder> implements DeslizarParaAccion.ItemTouchHelperContract {
    ...
    private static OnItemMedClickListener mListener;
    ...
    public interface OnItemMedClickListener {
        void onItemMedClick(Serializable serializable, int position);
    }

    // Constructor del adaptador
    public MedListAdapter(Context context, ArrayList<Serializable> itemList) {
    ...
    // Configuración del listener de cambios de datos
    public void setOnItemClickListener(OnItemMedClickListener onItemClick) {
    ...
    @Override
    public void onRowClear(CitasListAdapter.ListViewHolder myViewHolder) {
